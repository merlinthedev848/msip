          ...
          {#each rules as rule}
            <div class="p-4 bg-slate-50/50 rounded-xl border border-slate-200 hover:border-slate-200 transition-colors flex items-center justify-between">
              ...
              <div class="flex space-x-1">
                <button aria-label="Move Up" class="p-1.5 text-gray-600 hover:text-slate-900 transition-colors"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path></svg></button>
                <button aria-label="Move Down" class="p-1.5 text-gray-600 hover:text-slate-900 transition-colors"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
              </div>
            </div>
          {/each}
        </div>
